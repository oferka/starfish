...
public class AccountsCsvReader {
    ...
    private Resource enterpriseAccountSystemsFile;
    ...
    public @NotNull List<AccountLine> read() {
        ...
        try {
            Reader reader = new FileReader(enterpriseAccountSystemsFile.getFile());
            ...
            log.error(String.format("Failed to read accounts from CSV file %s", enterpriseAccountSystemsFile.getFilename()), e);
        }
        return result;
    }
}
